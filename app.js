const demoCandidates={
  ...
  poodle:[
    {name:'크림색 푸들 · 암컷',place:'경기 시흥시 보호 공고',date:'발견 2일 전',score:96,why:'곱슬 털 · 소형 체형 · 털색'},
    {name:'흰색 푸들 믹스 · 수컷',place:'경기 광명시 보호 공고',date:'발견 4일 전',score:89,why:'털 질감 · 얼굴형 · 인접 지역'},
    {name:'베이지 소형 믹스견 · 암컷',place:'서울 금천구 보호 공고',date:'발견 5일 전',score:80,why:'체형 · 털색 · 날짜 범위'},
    {name:'흰색 장모 소형견 · 미상',place:'서울 구로구 보호 공고',date:'발견 9일 전',score:72,why:'크기 · 밝은 털색'}
  ]
};
const demos=[
  {id:'shiba',label:'예시 1',name:'갈색 시바',image:'./assets/demo-shiba.jpg',feature:'갈색 털, 뾰족한 귀, 중형견',location:'경기 화성시',date:'2026-09-08'},
  {id:'dachshund',label:'예시 2',name:'닥스훈트',image:'./assets/demo-dachshund.jpg',feature:'검정·갈색 털, 긴 몸, 짧은 다리',location:'경기 안성시',date:'2026-09-08'},
  {id:'poodle',label:'예시 3',name:'소형 푸들',image:'./assets/demo-poodle.jpg',feature:'곱슬 털, 소형견',location:'경기 시흥시',date:'2026-09-08'}
];
...
function renderDemos(){document.querySelector('#demoOptions').innerHTML=demos.map(x=>`<button class="demo-option" type="button" data-demo="${x.id}" aria-pressed="false"><img src="${x.image}" alt=""><span><small>${x.label}</small><b>${x.name}</b></span></button>`).join('')}
